...
exports.PAD = exports.BASE64_TABLE = void 0;
...
function getTable(table) {
    ...
    else if ((0, poliyfill_1.isArray)(table)) {
...
function createEncode(table, pad, strEncode) {
    ...
    return function (input) {
        let _u8arr;
        if ((0, poliyfill_1.isArray)(input) || (0, poliyfill_1.isUint8Array)(input)) {
            _u8arr = input;
        }
        else if ((0, poliyfill_1.isArrayBuffer)(input)) {
